...
DEFAULT_POINTS_SCORE_BITS = 8
DEFAULT_CHECKS_BITS = 4
FEATURE_HASH = 0x8f3f9d5a if (HAS_POINTS or HAS_CHECKS) else 0x5f234cb8
if HAS_POINTS or HAS_CHECKS:
    if HAS_POINTS and POINTS_SCORE_BITS != DEFAULT_POINTS_SCORE_BITS:
        FEATURE_HASH ^= (POINTS_SCORE_BITS & 0xFF) << 8
    if HAS_CHECKS and CHECKS_BITS != DEFAULT_CHECKS_BITS:
        FEATURE_HASH ^= (CHECKS_BITS & 0xFF)
